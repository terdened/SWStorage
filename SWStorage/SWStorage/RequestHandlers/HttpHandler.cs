...
namespace SWStorage.RequestHandlers
{
    class HttpHandler : BaseHandler
    {
        ...
        override protected void Handle(TcpClient client)
        {
            ...
            var requestUri = ParseData(Request, client);

            if (requestUri == String.Empty)
                return;

            FindFile(requestUri, client);
        }

        private string ParseData(string Request, TcpClient client)
        {
        ...
        private void FindFile(string requestUri, TcpClient client)
        {
